...
La Tabla~\ref{tab:resultados} resume el comportamiento de los
algoritmos sobre cada variante con $\beta=200$ y 5 reinicios.
Reportamos número de movimientos del plan encontrado (o ``--'' si no se
halló), nodos expandidos y tiempo en segundos.
